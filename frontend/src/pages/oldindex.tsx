    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <Flex flexWrap="wrap" alignItems="center" justifyContent="center" maxW="800px" mt="10">
          ...
          <Box as="a" href="ttps://github.com/vercel/next.js/tree/master/examples" p="6" m="4" borderWidth="1px" flexBasis={['auto', '45%']}>
          ...
          <Box as="a" href="https://vercel.com/new?utm_source=create-next-app&utm_medium=default-template&utm_campaign=create-next-app" p="6" m="4" borderWidth="1px" flexBasis={['auto', '45%']}>
